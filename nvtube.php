...
if ($baodu == true) {echo"$acten ĐÃ LÀM ĐỦ 25 JOB\r";sleep(2);mothai();continue;}
...
elseif ($jobtup === "DA GIOI HAN")   {echo "$acten DA GIOI HAN\r";break;}
elseif ($jobtup === "HET JOB") {echo "DA HET JOB\r";sleep(2);mothai();
if ($mi > 1) {break;}
continue;}
break;} ////cv
