...
$tsm = tsm();
$jobtup = jobtup ();
    if ($jobtup === "KHONG TON TAI") {exit;}
elseif ($jobtup === "DA GIOI HAN") {exit;}
...
$tsm05   = tsmtup();
$dangky = dangky();
if ($dangky === "KENH NAY LOI") {exit;}
$pama = $dangky['pama'];
$kenh = $dangky['kenh'];
$tsmchon = 3;
$tsm92   = tsmtup();
$dangky1 = dangky1();
if ($dangky1 === "COOKIE DIE") {exit;}
if ($dangky1 === "DANG KY LOI") {exit;}
...
$tsm92   = tsmtup();
$comen = commen ();
if ($comen === "KENH NAY LOI") {exit;}
if ($comen === "KHONG CO CHO BL") {exit;}
if ($comen === "COOKIE DIE") {exit;}
if ($comen === "COMMEN THAT BAI") {exit;}
