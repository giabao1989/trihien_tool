...
$luuthu = "$token|$user|$ttp$idtup|$xgo|$tenyou|$kenhyou|$thutup|$cokitup";
...
if ($chanel === $kenhyou) {echo"COOKIE NAY KHONG KHOP VOI KENH DK VOI GOLIKE\n";sleep(3);clear();continue;}
$suathu = file('tkgo.txt', FILE_IGNORE_NEW_LINES);
$suathu[$xchon] = "$tonglai|$idtup|$xgo|$tenyou|$kenhyou|$thutup|$cokitup";
$chonsua = 2;tong();$chonsua = '';
echo "DA LUU LAI COOKIE YOUTUBE $tenyou VAO FILE\r";sleep(3);clear();
break;} /// pp2
} ///// po1
continue;} ///// 4
