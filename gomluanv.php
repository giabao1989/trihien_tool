...
function times() {
global $name, $tim, $delay, $delay1, $delay2, $tienxu, $loa_job, $vitri;
...
while (1) {
$i++;
if ($i > $delay1) {mothai();break;}

$color = $mau[array_rand($mau)];
$hhp = "\033[".$color."m$name NHAN DUOC $tienxu VND [ $i | $delay1 ] [ $vitri ]\033[0m\r";
...
while (1) {
$i++;
if ($i > $delay2) {mothai();break;}

$color = $mau[array_rand($mau)];
$hhp = "TOOL TAM NGHI [ $delay | $i ]\r";
...
$delay2 = input("CHAY HET FACEBOOK CHO TOOL NGHI");
