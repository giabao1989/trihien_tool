...
while (1) {$mivi++;$baku=0;
$chaylike = chaylike();
if ($chaylike === "HET FB") {tineo();break;}
$namefb = $chaylike['namefb'];
$cookie = $chaylike['mcoki'];
echo "$namefb LAM VIEC\r";
...
$dem1 = strlen($id);
if ($dem1 < 3 || $dem1 > 30) {baoloi();continue;}
...
$notong = tonghop();
    if ($notong === "CHECK POI")        {xoafb($mivi);break;}
elseif ($notong === "THA TIM LOI")      {echo"THA TIM LOI NHE\r";sleep(2);baoloi();continue;}
elseif ($notong === "CHAN TT")          {xoafb($mivi);break;}
