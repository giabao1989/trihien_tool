...
function metok () {
    ...
    if ($mekok == 1) {
        while (1) {
            ...
            if ($i > $metok) {mothai(); break;}

            $c = $mau[array_rand($mau)];

            echo "\033[".$c."m HẾT JOB [ $i | $metok ]\033[0m\r";
            sleep(1);
        }
    }
    ...
    if ($mekok == 2) {
        while (1) {
            ...
            echo "\033[".$c."m ĐỢI HẾT $metok | $i GIÂY  LẤY JOB MỚI\033[0m\r";
            sleep(1);
        }
    }
}
...
function toktc() {global $thanhcong, $accounts, $vitri, $tienxu, $baodi, $caigiday, $dalam, $acten;
...
if ($nha >= 5) {$nha=0;echo "TIKTOK $tikten NHÃ FOLLOW\n";break;}
continue;}
$nha=0;
